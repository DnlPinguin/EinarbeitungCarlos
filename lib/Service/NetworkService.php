...
class NetworkService {
  ...
  public function request(string $userId, string $endPoint, array $params = [], string $method = 'GET',
    ...
    try {
      $url = ($doormanApiRequest ? Application::DOORMAN_API_URL : '') . $endPoint;
      $options = [
        'headers' => [
      ...
      $this->logger->warning('Doorman API error : ' . $body, ['app' => Application::APP_ID]);
      return ['error' => $e->getMessage()];
    } catch (Exception | Throwable $e) {
      $this->logger->warning('Doorman API error', ['exception' => $e, 'app' => Application::APP_ID]);
      return ['error' => $e->getMessage()];
    }
  }
}
