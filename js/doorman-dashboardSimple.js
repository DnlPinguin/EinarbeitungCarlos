...
function renderWidget(el) {
  const gifItems = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('doorman', 'dashboard-widget-items');
...
document.addEventListener('DOMContentLoaded', () => {
  OCA.Dashboard.register('doorman-simple-widget', (el, {
    widget
  }) => {
    renderWidget(el);
  });
...
/******/ })()
;
//# sourceMappingURL=doorman-dashboardSimple.js.map